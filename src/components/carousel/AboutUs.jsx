...
const AboutUs = () => {
  return (
        <div className='flex justify-around bg-white p-16'>
            {/* left side */}
            <div className='w-1/2 text-black mr-4'>
                ...
                <p className='text-xl'>irure dolor in reprehenderit in voluptate trideta storacalaperda mastiro dolore eu fugiat nulla pariatur.</p>
                 ...
                 <button className="btn btn-success mt-8 text-white">Read More <FaArrowRight className='text-black inline text-white'/></button>
            </div>
