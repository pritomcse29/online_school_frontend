    ...
    <form className="space-y-6" action="#" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div>
        ...
        <input
          ...
          name="email"
          id="email"
          className="w-full p-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
     ...
     placeholder="••••••••"
      ...
      <div className="flex items-center justify-between">
        <label htmlFor="remember" className="flex items-center space-x-2 text-sm font-medium text-gray-900 dark:text-gray-300">
          <input
            id="remember"
            type="checkbox"
            className="w-4 h-4 text-emerald-500 bg-gray-100 border-gray-300 rounded focus:ring-emerald-500 dark:bg-gray-700 dark:border-emerald-500 dark:focus:ring-emerald-500"
          />
      ...
      <button
        type="submit"
        className="w-full px-5 py-2.5 text-sm font-medium text-white bg-emerald-500 rounded-lg hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-emerald-500 dark:bg-emerald-500 dark:hover:bg-emerald-600 dark:focus:ring-emerald-500"
      >
        Create your account
      </button>
      ...
      <div className="text-sm font-medium text-center text-gray-500 dark:text-gray-300">
        Already registered?{" "}
        <Link to='/login' className="text-emerald-500 hover:underline dark:text-emerald-500">
           Login Account
        </Link>
